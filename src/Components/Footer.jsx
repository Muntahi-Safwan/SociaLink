...
export default function Footer() {
    return (
        <section className="footer-bg relative overflow-hidden mt-10 bg-white py-8">
                ...
                <div className="-m-8 flex flex-wrap items-center justify-between">
                        ...
                        <a href="#">
                            <div className="inline-flex items-center">
                                <h1 className="font-bold text-[42px] text-[#BC246F]">
                                    Socia
                                    <span className="text-[#65AFE0]">Link</span>
                                </h1>
                            </div>
                        </a>
                    </div>
                    <div className="w-auto p-8">
                        <ul className="-m-5 flex flex-wrap items-center">
                            <li className="p-5">
                                <a
                                    className="font-medium text-white hover:text-[#BC246F]"
                                    href="#"
                                >
                                    Privacy Policy
                                </a>
